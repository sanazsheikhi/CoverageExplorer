...
class Sampling:
    ...
    def f(self, state, mean=None, cov_=1000):
    ...
    def rejection_sampling(self, seed=None, init_vec=None):
        ...
        while out is None:
            ...
            # state = [init_vec[3] + np.random.random() * 50000, init_vec[4] + np.random.random() * 50000]
